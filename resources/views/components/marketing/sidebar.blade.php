<ul>
    ...
    <li class="{{ (request()->is('marketing/pricelist*')) ? 'active' : '' }}">
        <a href="{{ route('marketing.pricelist.index') }}"><i class="fa fa-wheelchair"></i> <span>Pricelist</span></a>
    </li>
    <li class="{{ (request()->is('marketing/doctor*')) ? 'active' : '' }}">
        <a href="{{ route('marketing.doctor.index') }}"><i class="fa fa-user-md"></i> <span>Doctors</span></a>
    </li>
    <li class="{{ (request()->is('marketing/patient*')) ? 'active' : '' }}">
        <a href="{{ route('marketing.patient.index') }}"><i class="fa fa-wheelchair"></i> <span>Patients</span></a>
    </li>
